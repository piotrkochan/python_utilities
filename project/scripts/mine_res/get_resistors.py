...
args = [
    ...
    ('filter[fields][specs.resistance_tolerance.value][]', u'\u00b11%'.encode('utf-8')),
    # ('filter[fields][specs.resistance_tolerance.value][]', u'\xb11%'),
    # ('filter[fields][specs.resistance_tolerance.value][]', '1%'),
